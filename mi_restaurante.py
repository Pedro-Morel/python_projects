...
def guardar():
    ...
    archivo.close()
    messagebox.showinfo('Informaicón', 'Su recibo ha sido guardado')
...
aplicacion.title('Mí Restaurante - Sistema de Facturación')
...
# Panel comidas
panel_comidas = LabelFrame(panel_izquierdo, text='Comida', font=('bold', 15, 'bold'),
                           bd=1, relief=FLAT, fg='azure4')
panel_comidas.pack(side=LEFT)

# Panel bebidas
panel_bebidas = LabelFrame(panel_izquierdo, text='Bebidas', font=('bold', 15, 'bold'),
                           bd=1, relief=FLAT, fg='azure4')
panel_bebidas.pack(side=LEFT)

# Panel postres
panel_postres = LabelFrame(panel_izquierdo, text='Postres', font=('bold', 15, 'bold'),
                           bd=1, relief=FLAT, fg='azure4')
...
lista_bebidas = ['agua', 'soda', 'jugo', 'cola', 'vino1', 'vino', 'cerveza1', ' cerveza2']
